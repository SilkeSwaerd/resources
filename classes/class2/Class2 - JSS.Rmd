...
knitr::opts_knit$set(root.dir = "C:/Users/silke/OneDrive/Skrivbord/Aarhus Universitet/VT24/Methods 2 - General linear model/resources/classes/class2/Class2 - JSS.Rmd")
```
...
I have no idea, am I supposed to know that? And where would I have that information from??

### Ex. B: When would you use for-loops and when would you use while-loops? Explain in your own words in 1-2 sentences
Still no idea, I have no clue whatsover
...
convert_to_celsius <- function(fahrenheit) {
  temperature_C = (fahrenheit-32)*(5/9)
}
temp <- convert_to_celsius(68)
print(temp) 
...
advice <- clothing_advice(4)
advice <- clothing_advice(26)
